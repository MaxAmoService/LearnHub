...
<svg viewBox="0 0 680 100" xmlns="http://www.w3.org/2000/svg" style="max-width:680px;margin:1rem auto;display:block">
  ...
  <text x="75" y="62" text-anchor="middle" fill="#64748b" font-size="10">Code bearbeiten</text>
  <text x="75" y="18" text-anchor="middle" fill="#94a3b8" font-size="10">💻</text>
  ...
  <text x="225" y="62" text-anchor="middle" fill="#64748b" font-size="10">git add</text>
  <text x="225" y="18" text-anchor="middle" fill="#94a3b8" font-size="10">📋</text>
  ...
  <text x="385" y="62" text-anchor="middle" fill="#64748b" font-size="10">git commit</text>
  <text x="385" y="18" text-anchor="middle" fill="#94a3b8" font-size="10">🗄️</text>
  ...
  <text x="555" y="62" text-anchor="middle" fill="#64748b" font-size="10">git push</text>
  <text x="555" y="18" text-anchor="middle" fill="#94a3b8" font-size="10">☁️</text>
  <text x="640" y="50" text-anchor="middle" fill="#94a3b8" font-size="10">GitHub</text>
</svg>
...
<svg viewBox="0 0 700 200" xmlns="http://www.w3.org/2000/svg" style="max-width:700px;margin:1rem auto;display:block">
  ...
  <text x="120" y="28" text-anchor="middle" fill="#fca5a5" font-size="10">v1.0.0</text>
  <text x="350" y="28" text-anchor="middle" fill="#fca5a5" font-size="10">v1.1.0</text>
  <text x="580" y="28" text-anchor="middle" fill="#fca5a5" font-size="10">v1.2.0</text>
  <!-- dev branch -->
  ...
  <text x="650" y="40" fill="#94a3b8" font-size="10">(Releases)</text>
  <text x="650" y="100" fill="#94a3b8" font-size="10">(Entwicklung)</text>
</svg>
